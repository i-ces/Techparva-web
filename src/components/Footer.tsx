...
const Footer = () => {
  return (
    <footer className="flex flex-row justify-center bg-gradient-to-r from-indigo-700 via-purple-600 to-indigo-700 text-white relative overflow-hidden">
      ...
      <AnimateLogo name="/icons/AIArtBattle.svg" cls="bottom-20 right-20" />
      <AnimateLogo name="/icons/CTF.svg" cls="bottom-40 right-40" />
      <AnimateLogo name="/icons/CWC.svg" cls="top-20 right-20" />
      <AnimateLogo name="/icons/Datathon.svg" cls="top-0 right-0" />

      <AnimateLogo name="/icons/BlindTech.svg" cls="bottom-0 left-0" />
      <AnimateLogo name="/icons/GenAI.svg" cls="bottom-20 left-20" />
      <AnimateLogo name="/icons/Roadmap.svg" cls="top-40 left-40" />
      <AnimateLogo name="/icons/TypeNinja.svg" cls="top-20 left-20" />
      <AnimateLogo name="/icons/WikiSpeedrun.svg" cls="top-0 left-0" />
